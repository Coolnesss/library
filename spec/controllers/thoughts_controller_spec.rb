...
RSpec.describe ThoughtsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: thought.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      thought = Thought.create! valid_attributes
      get :edit, params: {id: thought.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Thought" do
        expect {
          post :create, params: {thought: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {thought: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested thought" do
        thought = Thought.create! valid_attributes
        put :update, params: {id: thought.to_param, thought: new_attributes}, session: valid_session
        thought.reload
      ...
      it "redirects to the thought" do
        thought = Thought.create! valid_attributes
        put :update, params: {id: thought.to_param, thought: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        thought = Thought.create! valid_attributes
        put :update, params: {id: thought.to_param, thought: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested thought" do
      thought = Thought.create! valid_attributes
      expect {
        delete :destroy, params: {id: thought.to_param}, session: valid_session
      }.to change(Thought, :count).by(-1)
    end
