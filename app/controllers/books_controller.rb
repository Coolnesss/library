class BooksController < ApplicationController
  ...
  private
    ...
    def book_params
      params.require(:book).permit(:name, :isbn, :name_eng, :author, :author_sindhi, :language, :description_sindhi, :description_eng, :year, :publisher, :attachment, categories_attributes: [:id, :name, :_destroy])
    end
